...
<body data-home-page="Home.html" data-home-page-title="Home"
	data-path-to-root="./" data-include-products="true"
	class="u-body u-overlap u-overlap-contrast u-xl-mode" data-lang="en">

	<jsp:include page="/WEB-INF/views/layout/header.jsp" />

	<section class="u-clearfix u-grey-5 u-block-60d2-1"
		custom-posts-hash="[]" data-style="blank"
		data-section-properties="{&quot;margin&quot;:&quot;none&quot;,&quot;stretch&quot;:true}"
		id="sec-84cf" data-id="60d2" style="">
		<div class="u-clearfix u-sheet u-block-60d2-2"
			style="min-height: 674px">
			<p
				class="u-text u-text-palette-1-base u-block-control u-block-60d2-17"
				style="margin-top: 94px; margin-right: 80px; margin-bottom: 0"
				data-block="11" data-block-type="Text">
				​<span class="u-file-icon u-icon u-block-control u-block-60d2-18"
					...
					data-block="12" data-block-type="Icon"><img
					src="/10bc3df0da2a6a/7078310.png" alt="" data-original-src=""
					data-color=""></span>&nbsp;>> Thông tin sản phẩm​​
			</p>
			<div
				class="custom-expanded data-layout-selected u-clearfix u-layout-wrap u-block-control u-block-60d2-3"
				...
				<div class="u-layout">
					<div class="u-layout-row">
						...
						<div
							...
							data-cell-id="2" data-column-id="2" data-block="15"
							...
							<div class="u-container-layout u-block-60d2-7"
								...
								<h3 class="u-text u-block-control u-block-60d2-8"
									...
									​<span
										class="u-file-icon u-icon u-block-control u-block-60d2-21"
										style="font-size: 2.0715em; margin-right: 3px; vertical-align: -11px"
										data-block="17" data-block-type="Icon"><img
										src="/6f0e356639810/9752776.png" alt=""
										data-original-src="/6f0e356639810/9752776.png" data-color=""></span>&nbsp;${product.name }
								</h3>
								<!-- Price Display -->
								<div style="display: flex;">
									<h4 id="price"
										class="u-text u-text-custom-color-5 u-block-control u-block-60d2-9"
								...
								<div style="display: inline-flex;">
									<p
										class="u-text u-text-default u-block-control u-block-60d2-22"
									...
									<div
										...
										<a class="minus u-button-style u-quantity-button"
											onclick="changeQuantity('minus')"> <svg
												xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
            								<path d="m 4 8 h 8" fill="none"
													stroke="currentColor" stroke-width="1" fill-rule="evenodd"></path>
        										</svg>
										</a> <input id="quantityInput" class="u-input u-block-90d4-49"
											type="text" value="1" pattern="[0-9]+" min="1"> <a
											class="plus u-button-style u-quantity-button"
											onclick="changeQuantity('plus')"> <svg
												xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
								...
								<div style="display: block">
									<div style="display: inline-flex">
										...
										<p
											class="u-text u-text-default u-block-control u-block-60d2-23"
...
.sizebutton.selected {
	background-color: #4CAF50; /* Màu nền cho nút đã chọn */
...
.u-quantity-input input {
	text-align: center;
	width: 60px; /* Đã thay đổi kích thước chiều rộng */
	padding: 5px;
	font-size: 1rem;
	border: 1px solid #ccc;
	border-radius: 5px;
...
.u-quantity-input input:focus {
	outline: none;
								...
								<a
									...
									data-block="26" data-block-type="Icon"> <img
										src="/b9e86569af7a8/3594363.png" alt=""
										data-original-src="/b9e86569af7a8/3594363.png" data-color="">
									...
									data-block="28"><img src="/90a6a37694106/825575.png"
										alt="" data-original-src="/90a6a37694106/825575.png"
										data-color=""></span>&nbsp;Mua ngay​
								</a>
							</div>
						</div>
					</div>
