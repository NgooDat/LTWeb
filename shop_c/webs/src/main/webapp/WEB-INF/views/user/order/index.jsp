				...
				<a href="home.htm" style="position: absolute; margin-left: 45px"
					class="u-active-none u-btn u-button-style u-cart-continue-shopping u-hover-none u-none u-text-body-color u-block-90d4-58"><span
						class="u-icon u-block-90d4-59"><svg xmlns="http://www.w3.org/2000/svg"
							...
							class="u-svg-content" viewBox="0 0 443.52 443.52" x="0px" y="0px" data-color="#000000"
					...
					<table class="u-table-entity u-block-90d4-12">
						...
						<thead class="u-custom-color-1 u-table-header u-block-90d4-13">
							<tr style="height: 33px;">
								<th class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-14">Mã
									đơn hàng</th>
								<th class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-12">Ngày
									tạo</th>
								<th class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-15">Tổng
									số lượng</th>
								<th class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-16">Tổng
									tiền</th>
								<th class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-16">Trạng
									thái</th>
								<th class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-17">Thao
									tác</th>
							</tr>
						</thead>
										...
										<div
											...
											<div class="u-price-wrapper">
												<div class="u-old-price"
													style="text-decoration: line-through !important;"></div>
												<div class="u-price" style="font-weight: 700; font-size: 1rem;">
													<fmt:formatNumber value="${order.order.total}" type="number"
														groupingUsed="true" />
													₫
												</div>
											</div>
