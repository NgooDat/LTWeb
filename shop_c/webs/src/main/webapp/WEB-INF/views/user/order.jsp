                        ...
                        <table class="u-table-entity u-block-90d4-12">
                            ...
                            <thead class="u-custom-color-1 u-table-header u-block-90d4-13">
                                <tr style="height: 33px;">
                                    ...
                                    <th class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-17">Tiền+Ship</th>
                                    <th class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-16">Trạng thái </th>
                                    <th class="center u-border-3 u-border-grey-15 u-table-cell u-block-90d4-17">Thao tác </th>
                                </tr>
                            </thead>
                                ...
                                <tr style="height: 100px;">
                                    ...
                                    <td class="center u-border-1 u-border-grey-15 u-table-cell u-block-90d4-45">
                                        <div class="center u-cart-product-price u-product-control u-product-price u-block-90d4-46">
                                            <div class="u-price-wrapper">
                                                <div class="u-old-price" style="text-decoration: line-through !important;"></div>
                                                <div class="u-price" style="font-weight: 700; font-size: 1rem;">${detail.quantity}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="center u-border-1 u-border-grey-15 u-table-cell u-block-90d4-45">
                                        <div class="center u-cart-product-price u-product-control u-product-price u-block-90d4-46">
                                            <div class="u-price-wrapper">
                                                <div class="u-old-price" style="text-decoration: line-through !important;"></div>
                                                <div class="u-price" style="font-weight: 700; font-size: 1rem;">${detail.total}</div>
                                            </div>
                                        </div>
                                    </td>
